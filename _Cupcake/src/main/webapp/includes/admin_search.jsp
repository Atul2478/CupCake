            ...
            <div class="col-lg-12">
                <div class="card pull-left" style="display:inline-block;">
                    ...
                    <div class="card-body" style="padding: 10px;">
                        <h5 class="card-title"><i>Email: <% out.println(searchedUser.getEmail()); %></i></h5>
                        <h5 class="card-title"><i>Brugernavn: <% out.println(searchedUser.getUsername()); %></i></h5>
                        <h5 class="card-title"><i>Balance: $ <% out.println(searchedUser.getBalance()); %></i></h5>
                        <h5 class="card-title"><i>Antal Ordre: <% out.println(amountOfOrders); %></i></h5>

                        <form method="post" action="/admin">
                            <input type="hidden" name="money-user-id" value="<%out.println(searchedUser.getId());%>" />
                        ...
                        <form method="post" action="/admin">
                        <button class="btn btn-danger" name="delete-user" value="<% out.println(searchedUser.getId()); %>">Slet Bruger</button>
                        </form>
